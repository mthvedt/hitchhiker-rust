...
import com.thunderhead.core.kv.local.{TransactionalStore, TransactionHandle, TxTracker}
...
/**
  ...
  */
class KvStoreSimple extends TransactionalStore {
...
//  val transactions: MMap[TransactionHandle, TransactionView] = MMap.empty
  ...
  def internalOpenTransaction(): TransactionView = new TransactionView {
  ...
  override def openTransaction(): TxTracker = {
